...
class Individ_T:
    ...
    def calculate_fitness(self) -> float:
        ...
        self.fitness= FITMAP(self.phenotype )
        return self.fitness
...
if plt:
    t1path     =  os.path.join(outdir,'t1','t1_i1.csv')
    fitpath    =  os.path.join(outdir,'avg_fitness','avg_fitness_i1.csv')
    bratepath  =  os.path.join(outdir,'brate','brate_i1.csv')
    ...
    plt.show()
    plt.savefig(os.path.join(outdir,f"itern_{itern}.png"))